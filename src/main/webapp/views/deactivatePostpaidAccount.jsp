...
<body>
	...
	<br>
	<h1 align="center">Deactivate Your Post Paid Account</h1>
	<br><br>
	<form name="OpenAccountForm" method="post" action="deactivatePostpaidAccountController">
		...
		<td><input type="number" name="mobileNo" pattern="[1-9]{1}[0-9]{8}"/></td>
			...
			<tr>
				<td align="center" colspan="2"><input type="submit"  value="Deactivate Account" class="button"/></td>
			</tr>
		</table>
	</form>
