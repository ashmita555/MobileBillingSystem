...
<title>Insert title here</title>
	...
	<iframe  name="mainFrame"  id="frame2" frameborder="0" src="loginPage" style="border-style: none; border-color: inherit; border-width: 0px; height:800px; width:100%;"></iframe>
</html>